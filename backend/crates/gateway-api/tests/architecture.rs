...
fn source_tree_should_match_frozen_machine_manifest() {
    ...
    let mut expected = vec![
        ...
        "src/admin/subscription_billing/mod.rs",
        "src/admin/subscription_billing/requests.rs",
        "src/admin/subscription_billing/views.rs",
        "src/admin/system.rs",
        "src/admin/users.rs",
        "src/admin/wire.rs",
        "src/auth.rs",
        ...
        "src/user/billing.rs",
        "src/user/client_keys/mod.rs",
        "src/user/client_keys/wire.rs",
        "src/user/mod.rs",
        "src/user/usage.rs",
    ];
...
fn test_tree_should_match_frozen_rust_mirror() {
    ...
    let mut expected = vec![
        ...
        "tests/admin/subscription_billing/mod.rs",
        "tests/admin/system.rs",
        "tests/admin/users.rs",
        "tests/admin/wire.rs",
